...
public class DeviceCharacteristic {
  ...
  // If active is false (and shown is true), it will be shown to the user as; "Hey, turning this off
  // will save energy"
  ...
  // Tips related to this characteristic will be shown when both this variable, and 'active' are
  // TRUE.
  ...
  public DeviceCharacteristic(
      String id, String value, String brand, Integer wattsSaved, boolean active, boolean shown) {
    this.id = id;
    this.value = value;
    this.brand = brand;
