package org.openremote.model.exit;

public class ShellyDeviceCharacteristic {
  ...
  // constructor
  public ShellyDeviceCharacteristic() {

  }

  public ShellyDeviceCharacteristic(String id, String value, boolean active, boolean shown) {
    this.id = id;
    this.value = value;
    this.active = active;
    this.shown = shown;
  ...
  public ShellyDeviceCharacteristic(String id, String value, String brand, Integer wattsSaved, boolean active, boolean shown) {
    this.id = id;
    this.value = value;
    this.brand = brand;
  ...
  public ShellyDeviceCharacteristic setId(String id) {
    this.id = id;
    return this;
  }
  ...
  public ShellyDeviceCharacteristic setValue(String value) {
    this.value = value;
    return this;
  }
  ...
  public ShellyDeviceCharacteristic setBrand(String brand) {
    this.brand = brand;
    return this;
  }
  ...
  public ShellyDeviceCharacteristic setWattsSaved(Integer wattsSaved) {
    this.wattsSaved = wattsSaved;
    return this;
  }
  ...
  public ShellyDeviceCharacteristic setActive(boolean active) {
    this.active = active;
    return this;
  }
  ...
  public ShellyDeviceCharacteristic setShown(boolean shown) {
    this.shown = shown;
    return this;
  }
}
