...
<head>
    ...
    <link rel="icon" type="image/png" href="${url.resourcesPath}/img/reschool_favicon.png"/>
                    ...
                    <div class="row">
                        <div class="col s12 center">
                            <div id="header-wrapper">
                                <a id="logo" href="https://exit.udg.edu/project/reschool/">
                                    <img style="width:170px; margin-right:5px" src="${url.resourcesPath}/img/logo-exit-udg.png">
                                </a>
