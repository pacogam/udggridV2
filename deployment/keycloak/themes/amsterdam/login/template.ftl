...
<head>
    ...
    <link rel="icon" type="image/svg" href="${url.resourcesPath}/img/amsterdam_gemeente_favicon.svg"/>
                    ...
                    <div class="row">
                        <div class="col s12 center fadein-animation" style="--og-duration-medium-entry: 0.45s;">
                            <div id="header-wrapper">
                                ...
                                <!--<a id="logo" href="https://www.amsterdam.nl/">
                                    <img style="width:17px; margin-right:10px" src="${url.resourcesPath}/img/amsterdam_gemeente_favicon.svg">
                                </a>
