...
export function getAppStyle() {
  return css`
    :host {
      ...
      /* Titles */
      --og-font-size-title: 3rem; /* Main title */
      ...
      --og-easing-standard: cubic-bezier(0.4, 0, 0.2, 1);
      --og-easing-entry: cubic-bezier(0, 0, 0.2, 1);
      --og-easing-exit: cubic-bezier(0.4, 0, 1, 1);
    }
    ...
    .animate-swipeleft-enter {
      -webkit-animation: container-swipeleft-enter 300ms cubic-bezier(0, 0, 0.2, 1) var(--animate-offset);
      -webkit-animation-fill-mode: forwards;
      animation: container-swipeleft-enter 300ms cubic-bezier(0, 0, 0.2, 1) var(--animate-offset);
      animation-fill-mode: forwards;
    }

    .animate-swipeleft-exit {
      -webkit-animation: container-swipeleft-exit 300ms cubic-bezier(0, 0, 0.2, 1) var(--animate-offset);
      -webkit-animation-fill-mode: forwards;
      animation: container-swipeleft-exit 300ms cubic-bezier(0, 0, 0.2, 1) var(--animate-offset);
      animation-fill-mode: forwards;
    }
    ...
    .animate-swiperight-enter {
      -webkit-animation: container-swiperight-enter 300ms cubic-bezier(0, 0, 0.2, 1) var(--animate-offset);
      -webkit-animation-fill-mode: forwards;
      animation: container-swiperight-enter 300ms cubic-bezier(0, 0, 0.2, 1) var(--animate-offset);
      animation-fill-mode: forwards;
    }

    .animate-swiperight-exit {
      -webkit-animation: container-swiperight-exit 300ms cubic-bezier(0, 0, 0.2, 1) var(--animate-offset);
      -webkit-animation-fill-mode: forwards;
      animation: container-swiperight-exit 300ms cubic-bezier(0, 0, 0.2, 1) var(--animate-offset);
      animation-fill-mode: forwards;
    }
    ...
    .animate-fade-enter {
      -webkit-animation: container-fade-enter 200ms cubic-bezier(0, 0, 0.2, 1) var(--animate-offset);
      -webkit-animation-fill-mode: forwards;
      animation: container-fade-enter 200ms cubic-bezier(0, 0, 0.2, 1) var(--animate-offset);
      animation-fill-mode: forwards;
    }

    .animate-fade-exit {
      -webkit-animation: container-fade-exit 100ms cubic-bezier(0, 0, 0.2, 1);
      -webkit-animation-fill-mode: forwards;
      animation: container-fade-exit 100ms cubic-bezier(0, 0, 0.2, 1);
      animation-fill-mode: forwards;
    }
    ...
    .animate-slowfade-enter {
      -webkit-animation: container-slowfade-enter 200ms cubic-bezier(0, 0, 0.2, 1) var(--animate-offset);
      -webkit-animation-fill-mode: forwards;
      animation: container-slowfade-enter 200ms cubic-bezier(0, 0, 0.2, 1) var(--animate-offset);
      animation-fill-mode: forwards;
    }
