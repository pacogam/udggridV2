            ...
            <div style="display: flex; flex-direction: column; gap: 24px;">
                ...
                <div id="details-container">
                    <div class="details-item">
                        ...
                        ${when(this.challengeAsset?.attributes, () => {
                    ...
                    <div class="details-item">
                        ...
                        ${when(this.challengeAsset?.attributes, () => {
                            ...
                            const challengePointInterval: number | undefined = this.challengeAsset.attributes['challengeEarnPointInterval']?.value;
                            const pointsString = (!!challengeDuration && !!challengePointInterval) ? (challengeDuration / challengePointInterval) : '???';
                            return html`
                                <span class="text-primary bold" style="color: var(--og-color-neutral);">${i18next.t('panel_peakNotification.maxEarnings', { 'points': pointsString })}</span>
                            `;
                        }, () => html`
                            <span class="text-primary bold" style="color: var(--og-color-neutral)">
                                <or-translate value="error"></or-translate>
