...
import type { Chip, OgChips } from "../components/og-chips";
    ...
    return html`
      <div id="ev-container">
        <div id="ev-content">
          <div
            id="ev-icon"
            style="background-color: ${this.evInfo || this.vehicleAsset ? "var(--og-color-success)" : "var(--og-color-danger)"}"
          ></div>
            ...
            <div>
              <div style="display: flex; flex-direction: column; justify-content: space-between; gap: 8px;">
                <or-translate
                  ...
                  value=${hasEv ? "panel_evInfo.yourVehicle" : "panel_evInfo.noVehicleFound"}
                ></or-translate>
                ${when(
                  hasEv,
                  () => html`
    ...
    return html`
      <div style="display: flex; align-items: center; gap: 8px;">
        ...
        <or-translate
          class="text-tertiary"
          style="text-align: start;"
          value=${brand || "panel_evInfo.unknownBrand"}
        ></or-translate>
      </div>
      <div style="display: flex; align-items: center; gap: 8px;">
        ...
        <or-translate
          class="text-tertiary"
          style="text-align: start;"
          value=${model || "panel_evInfo.unknownModel"}
        ></or-translate>
      </div>
    `;
  }
        ...
        new OgDialog()
          ...
          .setActions([
            { actionName: "cancel", content: "cancel" },
            {
              ...
              content: "connect",
              action: () => {
                window.location.href = Constants.AUTHORIZE_EV_URL.replace(
                  "{meterId}",
                  this.meterAsset?.attributes?.deviceId?.value
                );
              },
            },
          ]) as any
