...
const styling = css`
  ...
  #text-title {
    -webkit-animation: fade-in-fwd 0.3s cubic-bezier(0.390, 0.575, 0.565, 1.000) 0.2s both;
    animation: fade-in-fwd 0.3s cubic-bezier(0.390, 0.575, 0.565, 1.000) 0.2s both;
  }

  #loading-indicator {
    -webkit-animation: fade-in-fwd 1.2s cubic-bezier(0.390, 0.575, 0.565, 1.000) 0.4s both;
    animation: fade-in-fwd 1.2s cubic-bezier(0.390, 0.575, 0.565, 1.000) 0.4s both;
  }

  #text-loading {
    text-align: center;
    -webkit-animation: fade-in-fwd 0.3s cubic-bezier(0.390, 0.575, 0.565, 1.000) 0.6s both;
    animation: fade-in-fwd 0.3s cubic-bezier(0.390, 0.575, 0.565, 1.000) 0.6s both;
  }
  ...
  #logout-button {
    -webkit-animation: fade-in-fwd 0.6s cubic-bezier(0.390, 0.575, 0.565, 1.000) 1.0s both;
    animation: fade-in-fwd 0.6s cubic-bezier(0.390, 0.575, 0.565, 1.000) 1.0s both;
  }
`;
            ...
            ${guard([this.dark, this.status, this.statusText], () => {
                return html`
                    <div class="${classMap(fullscreenClasses)}">
                        <og-usage-graphic .type="${GraphicType.HEADER_FOOTER}" fill="${true}" .dark="${this.dark}"></og-usage-graphic>
                            ...
                            <div id="loading-container" class="${classMap(backgroundClasses)}">
                                ...
                                <div id="loading-content">
                                    ...
                                    ${when(this.statusText, () => html`
                                        <span id="text-loading" style="${styleMap(statusStyles)}">${this.statusText}</span>
                                    `)}
                                    ${when(this.status === SplashStatus.FAILED, () => html`
                                        <div><!-- Extra whitespace --></div>
                                        <div id="loading-actions-container">
