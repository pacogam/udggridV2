    ...
    protected pages: OnboardPage[] = [
        {
            ...
            pageContent: (): TemplateResult => html`
                <div class="peakusage-container">
                    <div style="overflow: hidden;">
                        <video autoplay muted playsinline loop poster="images/graphlines1-onboarding-frame.jpg" style="width: 100%; margin: -30% 0;">
            ...
            pageContent: (): TemplateResult => html`
                <div class="peakusage-container">
                    <div style="overflow: hidden;">
                        <video autoplay muted playsinline loop poster="images/graphlines3-onboarding-frame.jpg" style="width: 100%; margin: -15% 0;">
