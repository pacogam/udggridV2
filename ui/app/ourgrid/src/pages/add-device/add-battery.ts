...
import { OgBatteryBrand, type OurgridMeterAsset } from "../../util/util";
...
export class PageAddBattery extends OgPage<GridAppStateKeyed> {
  ...
  stateChanged(state: GridAppStateKeyed): void {
    ...
    const characteristics = JSON.parse(
      this.userAsset?.attributes?.[PageAddBattery.HOUSEHOLD_CHARACTERISTICS_ATTRIBUTE]?.value
  ...
  render() {
    return html`
      <div class="page-wrapper">
        ...
        <div class="page-content">${until(this._getBatteryFormTemplate(), html`Loading...`)}</div>
        <og-input
          class="page-action"
          .type=${InputType.BUTTON}
          raised
      ...
      <div class="page-content-container">
        <div class="battery-option-item vertical">
          ...
          <og-input
            ...
            label=${i18next.t("addBattery.selectBrandPlaceholder")}
            style="width: 100%;"
