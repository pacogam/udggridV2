...
import { OgHeatPumpBrand, type OurgridMeterAsset } from "../../util/util";
  ...
  render() {
    return html`
      <div class="page-wrapper">
        ...
        <div class="page-content">${until(this._getHeatpumpFormTemplate(), html`Loading...`)}</div>
        <og-input
          class="page-action"
          .type=${InputType.BUTTON}
          raised
      ...
      <div class="page-content-container">
        <div class="heatpump-option-item vertical">
          ...
          <og-input
            ...
            label=${i18next.t("addHeatpump.selectBrandPlaceholder")}
            style="width: 100%;"
