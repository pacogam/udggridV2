...
import { type GridAppStateKeyed, setUserAsset } from "../../util/og-state";
          ...
          <div style="padding: 64px 0; display: flex; flex-direction: column; gap: 32px; text-align: center;">
            ...
            <div style="text-align: start;">
              <og-input
                ...
                filled
                minLength="1"
                .label="${i18next.t("setup.page2-inputlabel")}"
                style="width: 100%;"
            ...
            <div style="height: 25vh; display: flex; align-items: center; justify-content: center;">
              ${this._connectDongleTask.render({
                initial: () => html``,
                pending: () => html` <img src="images/dots-loading.svg" /> `,
                complete: (value) => html`
                  ${when(
                    value,
                    () => html`
                      ${when(
                        ...
                        () => html`
                          ...
                          ></panel-device-info>
                        `,
                        () => html` <img src="images/dots-loading.svg" /> `
                      )}
                    `
                  )}
                `,
