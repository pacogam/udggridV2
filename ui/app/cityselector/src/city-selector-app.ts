...
import type { OurGridConfig, OurGridGatewayCity } from "model";
...
import type { AltCity, City } from "./model";
...
export class CitySelectorApp extends LitElement {
      ...
      <div id="wrapper">
        ...
        <div id="content">
          ...
          <div id="content-container">
            <span class="text-secondary bold dark" style="text-align: center; width: 90%; max-width: 480px;"
              >${this._t("searchCityName")}</span
            >
              ...
              ${when(
                ...
                () => html`
                  <og-city-input
                    ...
                    raised
                    fullWidth
                    @or-mwc-input-changed="${(ev) => this._onCityRemove(ev)}"
                  ></og-city-input>
                `,
                () => html`
                  <og-city-input
              ...
              () => {
                ...
                return html`
                  <og-city-input
                    ...
                    @or-mwc-input-changed="${(ev) => this._onCityLogin(ev)}"
                  ></og-city-input>
                `;
              },
            ...
            <div id="city-list-error">
              ${when(
                this._selectedCity && !valid,
                () => html`
                  <span class="text-secondary bold dark" style="text-align: center;"
                    >${this._t("cityNotAvailable")}</span
                  >
                `
              )}
            </div>
   ...
   */
  protected async _fetchTranslationsFile(
    folderName: string,
    language: string,
    fileName = "app.json",
    signal?: AbortSignal
