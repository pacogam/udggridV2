...
/**
 * Custom agent implementation that extends the base Agent class for MyGrid
 * integration.
 * 
 * @see MyGridProtocol
...
public class MyGridAgent extends Agent<MyGridAgent, MyGridProtocol, MQTTAgentLink> {
    ...
    public static final AgentDescriptor<MyGridAgent, MyGridProtocol, MQTTAgentLink> DESCRIPTOR = new AgentDescriptor<>(
            MyGridAgent.class, MyGridProtocol.class, MQTTAgentLink.class);
    ...
    public static final AttributeDescriptor<String> MYGRID_REALM = new AttributeDescriptor<>("MyGridRealm",
            ValueType.TEXT).withOptional(false);
