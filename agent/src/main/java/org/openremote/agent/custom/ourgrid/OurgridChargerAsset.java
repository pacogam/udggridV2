...
public class OurgridChargerAsset extends ElectricityChargerAsset implements OurgridDeviceAsset {
  ...
  public static final AttributeDescriptor<String> MANUFACTURER =
      ElectricityChargerAsset.MANUFACTURER
          .withMeta(
              withAddedMeta(
                  ElectricityChargerAsset.MANUFACTURER.getMeta(),
                  new MetaItem<>(MetaItemType.ACCESS_RESTRICTED_READ)))
          .withOptional(false);

  public static final AttributeDescriptor<String> MODEL =
      ElectricityChargerAsset.MODEL
          .withMeta(
              withAddedMeta(
                  ElectricityChargerAsset.MODEL.getMeta(),
                  new MetaItem<>(MetaItemType.ACCESS_RESTRICTED_READ)))
          .withOptional(false);

  public static final AttributeDescriptor<Double> POWER =
      ElectricityChargerAsset.POWER.withMeta(
          withAddedMeta(
              ElectricityChargerAsset.POWER.getMeta(),
              new MetaItem<>(MetaItemType.ACCESS_RESTRICTED_READ),
              new MetaItem<>(MetaItemType.RULE_STATE),
              new MetaItem<>(MetaItemType.STORE_DATA_POINTS)));

  public static final AttributeDescriptor<Boolean> SUPPORTS_EXPORT =
      ElectricityChargerAsset.SUPPORTS_EXPORT.withMeta(
          withAddedMeta(
              ElectricityChargerAsset.SUPPORTS_EXPORT.getMeta(),
              new MetaItem<>(MetaItemType.ACCESS_RESTRICTED_READ)));

  public static final AttributeDescriptor<Boolean> VEHICLE_CONNECTED =
      ElectricityChargerAsset.VEHICLE_CONNECTED.withMeta(
          withAddedMeta(
              ElectricityChargerAsset.VEHICLE_CONNECTED.getMeta(),
              new MetaItem<>(MetaItemType.ACCESS_RESTRICTED_READ)));

  public static final AssetDescriptor<OurgridChargerAsset> DESCRIPTOR =
      new AssetDescriptor<>("ev-station", "8A293D", OurgridChargerAsset.class);
