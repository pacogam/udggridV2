...
public class EarneEnodeControlRequestMessage {
  ...
  public static class ChargingControlRequestMessage extends EarneEnodeControlRequestMessage {
    ...
    public ChargingControlRequestMessage(
        String userId, String deviceId, Discipline discipline, ChargingControlCommand command) {
  ...
  private EarneEnodeControlRequestMessage(
      String userId, String deviceId, Discipline discipline, Command command) {
    this.userId = userId;
    ...
    try {
      ...
      Class<?> commandClass =
          discipline == Discipline.HVAC
              ? HVACControlRequestMessage.class
              : ChargingControlRequestMessage.class;
