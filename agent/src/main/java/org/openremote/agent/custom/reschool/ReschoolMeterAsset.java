...
public class ReschoolMeterAsset extends Asset<ReschoolMeterAsset> {
    ...
    public static final AttributeDescriptor<Integer> CHALLENGE_POINTS = new AttributeDescriptor<>("challengePoints", ValueType.POSITIVE_INTEGER,
    ...
    public static final AttributeDescriptor<Integer> CHALLENGE_POINTS_CURRENT = new AttributeDescriptor<>("challengePointsCurrent", ValueType.POSITIVE_INTEGER,
    ...
    public static final AttributeDescriptor<Integer> CHALLENGE_POINTS_PER_CHALLENGE = new AttributeDescriptor<>("challengePointsPerChallenge", ValueType.INTEGER,
    ...
    public static final AttributeDescriptor<Double> CHALLENGE_EARNINGS = new AttributeDescriptor<>("challengeEarnings", ValueType.POSITIVE_NUMBER,
    ...
    public static final AttributeDescriptor<Double> CHALLENGE_POWER_LIMIT = new AttributeDescriptor<>("challengePowerLimit", ValueType.NUMBER,
    ...
    public static final AttributeDescriptor<Double> PEAK_POINTS = new AttributeDescriptor<>("peakPoints", ValueType.POSITIVE_NUMBER,
    ...
    public static final AttributeDescriptor<Double> TOTAL_POINTS = new AttributeDescriptor<>("totalPoints", ValueType.POSITIVE_NUMBER,
    ...
    public static final AttributeDescriptor<String> HOUSEHOLD_ENERGY_CHARACTERISTICS = new AttributeDescriptor<>("householdEnergyCharacteristics", ValueType.TEXT,
    ...
    public static final AttributeDescriptor<String> SMARTMETER_MODEL = new AttributeDescriptor<>("smartmeterModel", ValueType.TEXT,
    ...
    public static final AttributeDescriptor<Double> WIFI_SIGNAL = new AttributeDescriptor<>("wifiSignal", ValueType.NUMBER,
    ...
    public static final AttributeDescriptor<Double> POWER_IMPORT = new AttributeDescriptor<>("powerImport", ValueType.NUMBER,
    ...
    public static final AttributeDescriptor<Double> POWER_EXPORT = new AttributeDescriptor<>("powerExport", ValueType.NUMBER,
    ...
    public Optional<DeviceCharacteristic[]> getHouseholdCharacteristics() {
        Optional<String> jsonString = getAttributes().get(HOUSEHOLD_ENERGY_CHARACTERISTICS).flatMap(Attribute::getValue);
