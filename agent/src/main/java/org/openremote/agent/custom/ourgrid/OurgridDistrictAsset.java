...
public class OurgridDistrictAsset extends Asset<OurgridDistrictAsset> {
  ...
  static ForecastConfigurationWeightedExponentialAverage forecastConfig =
  ...
  public static final AttributeDescriptor<Integer> NUMBER_OF_HOUSEHOLDS =
  ...
  public static final AttributeDescriptor<String> CHALLENGES_ASSET_ID =
      new AttributeDescriptor<>(
          "challengesAssetId",
          ValueType.TEXT,
  ...
  public static final AttributeDescriptor<String> PEAKS_ASSET_ID =
      new AttributeDescriptor<>(
          "peaksAssetId",
          ValueType.TEXT,
  ...
  public static final AttributeDescriptor<Double> POWER_CORRECTION_FACTOR =
      new AttributeDescriptor<>(
  ...
  public static final AttributeDescriptor<Integer> ACTIVE_PERIOD =
      new AttributeDescriptor<>(
              "activePeriod",
              ValueType.POSITIVE_INTEGER,
  ...
  public static final AttributeDescriptor<Integer> NUMBER_OF_ACTIVE_POWER_READINGS =
      new AttributeDescriptor<>(
          "numberOfActivePowerReadings",
          ValueType.POSITIVE_INTEGER,
  ...
  public static final AttributeDescriptor<Integer> NUMBER_OF_DEVICES =
      new AttributeDescriptor<>(
          "numberOfDevices",
          ValueType.POSITIVE_INTEGER,
  ...
  public static final AttributeDescriptor<Double> ESTIMATED_SOLAR_CAPACITY_DISTRICT =
      new AttributeDescriptor<>(
              "estimatedSolarCapacityDistrict",
              ValueType.NUMBER,
  ...
  public static final AttributeDescriptor<Double> POWER_DISTRICT =
      new AttributeDescriptor<>(
              "powerDistrict",
              ValueType.NUMBER,
  ...
  public static final AttributeDescriptor<Double> POWER_CONSUMPTION_DISTRICT =
      new AttributeDescriptor<>(
              "powerConsumptionDistrict",
              ValueType.NUMBER,
  ...
  public static final AttributeDescriptor<Double> POWER_SOLAR_DISTRICT =
      new AttributeDescriptor<>(
              "powerSolarDistrict",
              ValueType.NUMBER,
  ...
  public static final AttributeDescriptor<Integer> POWER_IMPORT_PERCENTAGE =
      new AttributeDescriptor<>(
              "powerImportPercentage",
              ValueType.INTEGER,
  ...
  public static final AttributeDescriptor<Integer> POWER_IMPORT_CRITICAL_PERCENTAGE =
      new AttributeDescriptor<>(
              "powerImportCriticalPercentage",
              ValueType.INTEGER,
  ...
  public static final AttributeDescriptor<Boolean> TURN_ON_DYNAMIC_SOLAR_CAPACITY =
      new AttributeDescriptor<>(
          "turnOnDynamicSolarCapacity",
          ValueType.BOOLEAN,
          new MetaItem<>(MetaItemType.LABEL, "Turn on dynamic solar capacity"),
          new MetaItem<>(MetaItemType.RULE_STATE));

  public static final AssetDescriptor<OurgridDistrictAsset> DESCRIPTOR =
      new AssetDescriptor<>(
          "city", "64404c", OurgridDistrictAsset.class); // set icon and colour of asset
