 ...
 */
@Entity
public class EarneMeterAgent extends AbstractEarneAgent<EarneMeterAgent, EarneMeterProtocol, DefaultAgentLink> {

    public static final AttributeDescriptor<String> RABBITMQ_METER_QUEUE = new AttributeDescriptor<>("rabbitMqQueue", ValueType.TEXT,
    ...
    public static final AgentDescriptor<EarneMeterAgent, EarneMeterProtocol, DefaultAgentLink> DESCRIPTOR = new AgentDescriptor<>(EarneMeterAgent.class, EarneMeterProtocol.class, DefaultAgentLink.class);
