...
public class OurgridHvacAsset extends ThermostatAsset implements OurgridDeviceAsset {
    ...
    public static final AttributeDescriptor<Boolean> ALLOW_STOP_HEATPUMP_BUTTON = new AttributeDescriptor<>("allowStopHeatpumpButton", ValueType.BOOLEAN,
            new MetaItem<>(MetaItemType.ACCESS_RESTRICTED_READ),
            new MetaItem<>(MetaItemType.ACCESS_RESTRICTED_WRITE),
            new MetaItem<>(MetaItemType.RULE_STATE)
    );
    ...
    // Updated attributes
    public static final AttributeDescriptor<String> MANUFACTURER = ThermostatAsset.MANUFACTURER.withMeta(withAddedMeta(ThermostatAsset.MANUFACTURER.getMeta(),
                    new MetaItem<>(MetaItemType.ACCESS_RESTRICTED_READ)))
            .withOptional(false);

    public static final AttributeDescriptor<String> MODEL = ThermostatAsset.MODEL.withMeta(withAddedMeta(ThermostatAsset.MODEL.getMeta(), new MetaItem<>(
                    MetaItemType.ACCESS_RESTRICTED_READ)))
            .withOptional(false);


    public static final AssetDescriptor<OurgridHvacAsset> DESCRIPTOR = new AssetDescriptor<>("hvac", "f5b324", OurgridHvacAsset.class);
