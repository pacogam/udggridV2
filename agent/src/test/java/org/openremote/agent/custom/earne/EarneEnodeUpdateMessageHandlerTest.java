...
public class EarneEnodeUpdateMessageHandlerTest extends AbstractEarneMessageHandlerTest {
    ...
    @Mock
    EarneEnodeAgent agentMock;

    @Mock
    EarneEnodeProtocol protocolMock;

    @Captor
    ArgumentCaptor<Asset<OurgridChargerAsset>> chargerAssetCapture;

    @Captor
    ArgumentCaptor<Asset<OurgridHvacAsset>> hvacAssetCapture;

    @Captor
    ArgumentCaptor<Asset<OurgridVehicleAsset>> vehicleAssetCapture;
    ...
    void beforeEach() {
        ...
        handler = new EarneEnodeUpdateMessageHandler(agentMock, assetServiceMock, assetStorageServiceMock);
    ...
    private void assertNewChargerCreated(Asset<OurgridChargerAsset> asset, String parentId) {
        ...
        assertAssetAttributeValues(asset, Map.ofEntries(
    ...
    private void verifyChargerAttributeEventsSend() {
        ...
        verifyAttributeEventSend(CHARGER_ASSET_ID, OurgridChargerAsset.TIMESTAMP, "2020-04-07T17:04:26Z");
    }
    ...
    private void verifyVehicleAttributeEventsSend() {
        ...
        verifyAttributeEventSend(VEHICLE_ASSET_ID, OurgridVehicleAsset.TIMESTAMP, "2025-08-05T15:29:55.298Z");
    }
