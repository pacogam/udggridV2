...
public class EarneEnodeCommandSerializationTest {
  ...
  void assertJsonEquals(String expectedJson, EarneEnodeControlRequestMessage actual)
  ...
  void testChargingControlRequestMessageSerialization() throws JsonProcessingException {
    String json =
        """
                ...
                """;
    EarneEnodeControlRequestMessage message =
        new ChargingControlRequestMessage(
            "user123", "device123", Discipline.EV, ChargingControlCommand.START);
    ...
    message =
        new ChargingControlRequestMessage(
            "user456", "device456", Discipline.HVAC, ChargingControlCommand.STOP);
    assertJsonEquals(json, message);
  }
  ...
  void testHVACControlCommandSerialization() throws JsonProcessingException {
    String json =
        """
                ...
                """;
    EarneEnodeControlRequestMessage message =
        new HVACControlRequestMessage("user789", "device789", HVACControlCommand.OFF);
    assertJsonEquals(json, message);
    ...
    json =
        """
                ...
                """;
    message =
        new HVACControlRequestMessage("user321", "device321", HVACControlCommand.FOLLOW_SCHEDULE);
    assertJsonEquals(json, message);

    message =
        new HVACControlRequestMessage("user444", "device555", HVACControlCommand.COOL, 19.1, null);
    json =
        """
    ...
    message =
        new HVACControlRequestMessage("user212", "device212", HVACControlCommand.HEAT, null, 22.3);
    json =
        """
