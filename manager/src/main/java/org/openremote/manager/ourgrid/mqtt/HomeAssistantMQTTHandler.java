...
/**
 * This handler provides a workaround to allow Home Assistant to connect to the OpenRemote MQTT
 * broker.
 */
public class HomeAssistantMQTTHandler extends MQTTHandler {
  ...
  public boolean checkCanPublish(
      RemotingConnection connection, AuthContext authContext, Topic topic) {
  ...
  public Set<String> getPublishListenerTopics() {
    return Set.of(HOMEASSISTANT_TOPIC + "/" + TOKEN_MULTI_LEVEL_WILDCARD);
  }
